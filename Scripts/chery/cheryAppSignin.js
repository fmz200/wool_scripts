...
const chery_account = $.getdata('fmz200_chery_account');
const user_agent = `Mozilla/5.0 (iPhone; CPU iPhone OS 18_2 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Mobile/15E148 ios/1.0.0`;
...
let json_data = JSON.parse(chery_account);
process();
