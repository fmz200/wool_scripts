...
const $ = new Env("获取机场公告");

const url_airport = $.getdata('url_airport'); // 你的机场地址，例如 www.brd.life
const email_airport = $.getdata('email_airport'); // email=你的邮箱，如果失败把@符号写成%40
const password_airport = $.getdata('password_airport'); // password=你的密码
